...
<div class="row">
    <div id="todolist" class="col-md-3">
        <div class="card card-default">
            <div class="card-header">
                Add to Your To-do-list:
            </div>
            <div class="card-body">
                <form name="" id="formToDo" class="form control" action="">
                    <input type="text" id="newToDo"  />
                    <button class="btn-sm btn-primary" type = "button" onclick = "buttonMake()"> Add </button>
                    <br/><br/>
                </form>
            </div>
    ...
    <div id="weightcal" class="card card-default">
            <div>
                <div class="wcal">
                    ...
                    <div class="card-body">
                        <form name="" id="formWeightCal" class="form control" action="">
                            <input type="text" id="weightInput"  />
                            <button class="btn-sm btn-primary" type = "button" onclick = "inputWeight()"> Go </button>
                        </form>
                        <div id = "weightMsg">
                            <?php if( ( ($weight2 - $weight1) >= 5) and ($weight1 != null) ): ?>
                            <p> You gained:<?php echo e($weight2 - $weight1); ?> &nbsp; Better work your hardest the next time!</p>    
                    ...
                    <div id ="weightList" class="card-footer">
                        <?php $__empty_1 = true; $__currentLoopData = $weights->reverse()->slice(0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $weight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <p id="<?php echo e($weight->id); ?>" class="addToWeight"> Weight: <?php echo e($weight->weight); ?> &emsp; Date: <?php echo e(Carbon\Carbon::parse($weight->created_at)->format('l j F Y')); ?> </p>
